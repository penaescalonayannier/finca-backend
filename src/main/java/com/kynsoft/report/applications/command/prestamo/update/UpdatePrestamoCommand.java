...
@Getter
@Setter
public class UpdatePrestamoCommand implements ICommand {
    ...
    public UpdatePrestamoCommand(UUID id, Double importeAprobado, Double importeAprobadoEfectivo,
    ...
    public static UpdatePrestamoCommand fromRequest(UpdatePrestamoRequest request, UUID id) {
        return new UpdatePrestamoCommand(
                id,
    ...
    public ICommandMessage getMessage() {
        return new UpdatePrestamoMessage(id);
    }
}
