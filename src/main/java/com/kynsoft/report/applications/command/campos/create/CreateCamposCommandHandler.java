...
@Component
@AllArgsConstructor
public class CreateCamposCommandHandler implements ICommandHandler<CreateCamposCommand> {
    ...
    @Override
    public void handle(CreateCamposCommand command) {
        ...
        serviceImpl.create(CampoDto.builder()
                .id(command.getId())
                .bloque(bloqueDto)
